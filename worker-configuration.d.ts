...
declare namespace Cloudflare {
	interface Env {
		PRIVATE_COOKIE_NAMES: ["restorywiki_session","restorywikiToken"];
		PRIVATE_COOKIE_NAMES_DEV: ["devrestorywiki_session","devrestorywikiToken"];
		CLIENT_PREFS_COOKIE_NAME: "restorywikimwclientpreferences";
		CLIENT_PREFS_COOKIE_NAME_DEV: "devrestorywikimwclientpreferences";
		...
		CACHED_NAMESPACES: ["","Category","Project","ReStory_Wiki","Categoría","Categor%C3%ADa","Categoria","Catégorie","Cat%C3%A9gorie","カテゴリ","%E3%82%AB%E3%83%86%E3%82%B4%E3%83%AA","Wiki_Undertale_FR"];
	}
}
